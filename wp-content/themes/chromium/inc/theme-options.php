...
if (class_exists('Chromium_Kirki')) {
    ...
    Chromium_Kirki::add_field( 'chromium', [
        ...
        'label'       => esc_html__( 'Header Font', 'chromium' ),
        'description' => esc_html__( "Header Font", 'chromium' ),
        'section'     => 'title_tagline',
        'choices'     => [
            'fonts' => [
                'standard' => [
...
if (class_exists('WooCommerce')) {
    ...
    Chromium_Kirki::add_field( 'chromium', [
        ...
        'label'       => esc_html__( 'Global Font', 'chromium' ),
        'section'     => 'chromium-colors',
        'choices'     => [
            'fonts' => [
                'standard' => [
    ...
    Chromium_Kirki::add_field( 'chromium', [
        ...
        'label'       => esc_html__( 'Form fields font', 'chromium' ),
        'section'     => 'chromium-colors',
        'choices'     => [
            'fonts' => [
                'standard' => [
        ...
        'output'      => [
            [
                'element' => ['input','button','.button','textarea'],
            ],
        ],
    ] );
