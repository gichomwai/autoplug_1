		...
		<?php if (!$inline) { echo '<div class="tz-login-form-wrapper">'; } ?>
			...
			<form id="tz-login" class="ajax-auth" method="post">
				...
				<p class="username">
					...
					<input type="text" class="tz-login-username" placeholder="<?php esc_html_e('Username', 'tz-feature-pack');?>" name="username" required aria-required="true" pattern="<?php echo apply_filters('feedback_form_sender_pattern', '[a-zA-Z0-9_@+-. ]+'); ?>" title="<?php esc_html_e('Digits and Letters only.', 'tz-feature-pack'); ?>">
				</p>
				<p class="password">
			...
			<form id="tz-register" class="ajax-auth" method="post">
				...
				<p class="username">
					...
					<input class="tz-register-username" placeholder="<?php esc_html_e('Username', 'tz-feature-pack');?>" type="text" name="signonname" required aria-required="true" pattern="<?php echo apply_filters('register_form_username_pattern', '[a-zA-Z0-9_@+-. ]+'); ?>" title="<?php esc_html_e('Digits and Letters only.', 'tz-feature-pack'); ?>">
